...
pub struct CreateAssistantRequestToolResourcesFileSearchVectorStores {
    ...
    pub chunking_strategy:
        Option<CreateAssistantRequestToolResourcesFileSearchVectorStoresChunkingStrategy>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Metadata>,
}
...
pub enum CreateEvalItem {
    SimpleInputMessage { role: String, content: String },
    EvalItem(EvalItem),
}
...
pub struct CreateThreadRequestToolResourcesFileSearchVectorStores {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chunking_strategy:
        Option<CreateThreadRequestToolResourcesFileSearchVectorStoresChunkingStrategy>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Metadata>,
}
...
pub enum MCPToolAllowedTools {
    ...
    MCPallowedtoolsfilter { tool_names: Vec<String> },
}
...
pub enum MessageStreamEvent {
    ...
    A { event: String, data: MessageObject },
    /** Occurs when a [message](/docs/api-reference/messages/object) moves to an `in_progress` state. */
    B { event: String, data: MessageObject },
    ...
    D { event: String, data: MessageObject },
    /** Occurs when a [message](/docs/api-reference/messages/object) ends before it is completed. */
    E { event: String, data: MessageObject },
}
...
pub enum RunStepStreamEvent {
    ...
    A { event: String, data: RunStepObject },
    /** Occurs when a [run step](/docs/api-reference/run-steps/step-object) moves to an `in_progress` state. */
    B { event: String, data: RunStepObject },
    ...
    D { event: String, data: RunStepObject },
    /** Occurs when a [run step](/docs/api-reference/run-steps/step-object) fails. */
    E { event: String, data: RunStepObject },
    /** Occurs when a [run step](/docs/api-reference/run-steps/step-object) is cancelled. */
    F { event: String, data: RunStepObject },
    /** Occurs when a [run step](/docs/api-reference/run-steps/step-object) expires. */
    G { event: String, data: RunStepObject },
}
...
pub enum RunStreamEvent {
    ...
    A { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) moves to a `queued` status. */
    B { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) moves to an `in_progress` status. */
    C { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) moves to a `requires_action` status. */
    D { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) is completed. */
    E { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) ends with status `incomplete`. */
    F { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) fails. */
    G { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) moves to a `cancelling` status. */
    H { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) is cancelled. */
    I { event: String, data: RunObject },
    /** Occurs when a [run](/docs/api-reference/runs/object) expires. */
    J { event: String, data: RunObject },
}
